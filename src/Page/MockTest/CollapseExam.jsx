...
function CollapseExam(props) {
  ...
  return (
    <div className="">
      ...
      <ModalEditExam idExam={idExam} dataExam={dataExam} handleGetDataExam = {handleGetDataExam} />
      <ModalEditSection idSection={idSection} dataSection={dataSection} handleGetDataExam = {handleGetDataExam}/>
      <ModalEditQuestion dataQuestion={dataQuestion} answers={listAnswer} handleGetDataExam = {handleGetDataExam}/>
      <ModalAddQuestionToSection idSection={idSection} title = {sectionTitle} handleGetDataExam = {handleGetDataExam}/>
    </div>
  );
}
